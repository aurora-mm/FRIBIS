...
# 3. Bar chart. Own music, collabs, compilations (intent/paradigm/others). Or the third donut.
#    But make sure that the categories are mutually exclusive.
...
Own Music Albums: `r total_own`  

###

Collaborations: `r total_collab`

###

Compilations: `r total_compilation`